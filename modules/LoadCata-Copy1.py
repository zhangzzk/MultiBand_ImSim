...
def GalInfo(cata_pathfile, primary_band, bands,
    ...
    cata_idx = np.array(cata['cata_idx']).astype(int)
    data = [np.array(index).astype(int), cata_idx, np.array(X_gals).astype(float), np.array(Y_gals).astype(float), np.array(z_gals).astype(float),
    ...
    name = ['index','cata_idx','RA','DEC','redshift',
